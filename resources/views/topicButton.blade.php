<a href="/develop-yourself/topic/{{ $subject->title }}/{{ $subject->id }}:{{ $item }}" class="subjectButton" style="background: linear-gradient(to bottom right,{{ $subject->color1 }}, {{ $subject->color2 }})">
